The solution is not completed, only indicated, requests returns dummy results. Is implemented in C# NET Core 3.1 (it's a modern language and easy to understand)
...
I now it would be better to have a Database and a logger system. 
